...
export async function getDelegateById(id) {
  ...
  const delegateData = await fetchGraphQL(uniswapGovernanceSubgraphUrl, delegateQuery);
      ...
      delegates.map(async delegate => {
          ...
          votedProposalsData.data.votes.forEach(vote => {
              ...
              votingHistory.push({
                  ...
                  url: `https://app.uniswap.finance/governance/${vote.proposal.id}`,
              });
          });
          ...
          submittedProposalsData.data.proposals.forEach(proposal => {
              ...
              submittedProposals.push({
                  ...
                  url: `https://app.uniswap.org/governance/${proposal.id}`,
                  votesFor: votesFor,
                  votesAgainst: votesAgainst,
                  approved: approved,
              });
